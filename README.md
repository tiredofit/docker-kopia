# github.com/tiredofit/docker-kopia
...
This will build a Docker image for [kopia](https://www.kopia.io), a backup serrver
...
### Prebuilt Images
Builds of the image are available on [Docker Hub](https://hub.docker.com/r/tiredofit/kopia) and is the recommended method of installation.
...
| --------- | ----------------------------------------- |
| `/backup` | If using local backup - Backup files here |
| `/cache`  | Cache Files                               |
